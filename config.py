...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6408633647:AAE-UBjJs5MbofyL2K-2YwX76WRhWFZphUA")
...
# OWNER Uername without @
OWNER = os.environ.get("OWNER", "Razer358")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6001922744").split()):
        ADMINS.append(int(x))
except ValueError:
